...
public class Arm_Visitor implements Visitor {
    ...
    public Object visit(IdentifierExp node, Object data) {
        ...
        String result = "str\t" + regFormals[1] + ", [sp, " + location + "]\n" + "ldr\t"
                + regFormals[1] + ", [sp, " + location + "]\n" + "bl\t_print";
    ...
    public Object visit(IntegerLiteral node, Object data) {
        ...
        int i = node.i;
        String result = "mov\t" + regFormals[3] + ", #" + i + "\n" + "ldp\tx29, x30, [sp, #16]\n"
                + "add\tsp, sp, #32" + "\n";
    ...
    public Object visit(MethodDecl node, Object data) {
        ...
        prologueCode = "\n\n\n" + ".globl " + theLabel + "\n" + theLabel + ":\n" + ".p2align\t2\n"
                + ".cfi_startproc\n; %bb.0:\n" + "sub\tsp, sp, #" + (stackChange * align) + "\n"
                + ".cfi_def_cfa_offset " + (stackChange * align) + "\n" + "stp\tx29, x30, [sp, #"
                + (stackChange) + "]\n" + "add\tx29, sp, #" + (stackChange) + "\n"
                + ".cfi_def_cfa w29, " + (stackChange) + "\n.cfi_offset w30, "
                + (stackChange / -align) + "\n.cfi_offset w29, " + (-stackChange) + copyFormalsCode
                + initializeLocalsCode;


        epilogueCode = "ret\n.cfi_endproc\n.section\t__TEXT,__cstring,cstring_literals\nl_.str:\n"
                + asciz + ".subsections_via_symbols";
        return prologueCode + statementCode + expressionCode + epilogueCode;
    }
